...
```bash
bash <(curl -s https://raw.githubusercontent.com/Axcelsozu/themeinstaller/refs/heads/main/install.sh)
```
...
- Github Profile: [Axcel Sozu](https://github.com/axcelsozu)
- WhatsApp Channel: [KLIK DI SINI](https://whatsapp.com/channel/0029Vaji4SeLtOj6DEp4CO3G)
- Telegram Chat: [HUBUNGI ATMIN](https://t.me/axcelsozu)

<p align="center">Made with ❤️ by Axcel Sozu</p>
