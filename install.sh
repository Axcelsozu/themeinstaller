#!/bin/bash
# ============================================================
# SKRIP INI DIBUAT OLEH LAURENCE
# TELEGRAM: @axcelsozu
# DISARANKAN GAK USAH NYOLONG!
# LEBIH BAIK LANGSUNG PAKE AJA, KALO EROR BIAR GW (LAURENCE) YANG BENERINNYA, LU TINGGAL LAPOR AJA KE TELEGRAM.
# ============================================================
...
start_script() {
  ...
  echo -e "${BOLD}${BLUE}[+]                  © AXCEL SOZU                [+]${NC}"
  echo -e "${BOLD}${BLUE}[+]                                                 [+]${NC}"
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BOLD}${BLUE}[+]              AXCEL SOZU LICENSE              [+]${NC}"
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${BOLD}${YELLOW}MASUKKAN AKSES TOKEN: ${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "axcelsozu" ]; then
...
install_theme() {
  ...
  while true; do
    ...
    case "$SELECT_THEME" in
      1) THEME_NAME="Stellar"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/stellar.zip"; break;;
      2) THEME_NAME="Billing"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/billing.zip"; break;;
      3) THEME_NAME="Enigma"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/enigma.zip"; break;;
      4) THEME_NAME="Elysium"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/elysium.zip"; break;;
      5) THEME_NAME="Frostcore"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/frostcore.zip"; break;;
      6) THEME_NAME="Nightcore"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/nightcore.zip"; break;;
      7) THEME_NAME="IceMinecraft"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/ice.zip"; break;;
      8) THEME_NAME="Noobe"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/noobe.zip"; break;;
      9) install_timpa "https://github.com/reviactyl/panel/releases/latest/download/panel.tar.gz" "Reviactyl"; return;;
      [bB]1) THEME_NAME="Nebula V1.8-3"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/nebula_v1.8-3.zip"; break;;
      [bB]2) THEME_NAME="Nebula V2.0-1"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/nebula_v2.0-1.zip"; break;;
      [bB]3) THEME_NAME="Recolor"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/recolor.zip"; break;;
      [bB]4) THEME_NAME="NavySeals"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/navyseals.zip"; break;;
      [bB]5) THEME_NAME="LememTheme"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/lemem.zip"; break;;
      [bB]6) THEME_NAME="Darkenate"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/darkenate.zip"; break;;
      [bB]7) THEME_NAME="AbyssPurple"; THEME_URL="https://github.com/Axcelsozu/themeinstaller/raw/main/theme/abysspurple.zip"; break;;
...
create_node() {
  ...
  bash <(curl -s https://raw.githubusercontent.com/Axcelsozu/themeinstaller/main/createnode.sh)
...
install_auto_suspend() {
  ...
  wget -q https://github.com/Axcelsozu/themeinstaller/raw/main/autosuspend.zip
...
while true; do
  ...
  echo -e "${BOLD}${CYAN}gggg      gg     ,    ggg${NC}      ${BOLD}${BLUE}By Axcel Sozu${NC}"
  echo -e "${BOLD}${CYAN}ggg:     gg.     -   ,ggg${NC}     ${BOLD}${GREEN}----------------------------------${NC}"
  echo -e "${BOLD}${CYAN} ggg:     ggg._    _,ggg${NC}       ${BOLD}${BLUE}Telegram : @axcelsozu${NC}"
